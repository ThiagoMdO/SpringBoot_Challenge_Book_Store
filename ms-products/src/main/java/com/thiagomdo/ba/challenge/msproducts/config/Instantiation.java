...
public class Instantiation implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Product product1 = new Product(null, "Sapiens, Uma breve história da humanidade", "O planeta Terra tem cerca de 4,5 bilhões de anos.", 100.00);
        Product product2 = new Product(null, "Alerta Vermelho", "Bill Browder iniciou sua vida adulta como um rebelde de Wall Street cujos instintos...", 50.00);

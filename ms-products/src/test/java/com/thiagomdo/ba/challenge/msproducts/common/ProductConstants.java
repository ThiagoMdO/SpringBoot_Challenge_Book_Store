...
public class ProductConstants {
    ...
    public static final Product O_CORACAO_DO_MUNDO_BOOK = new Product("dasfx33", "O coração do mundo", "Uma nova história universal a partir da rota da seda: o encontro do oriente com o ocidente", 68.90);
    public static final ProductDTO O_CORACAO_DO_MUNDO_BOOK_DTO = new ProductDTO("dasfx33", "O coração do mundo", "Uma nova história universal a partir da rota da seda: o encontro do oriente com o ocidente", 68.90);
